...
public class Node{
	...
	public void calculateOutput()
	{
		...
		if(type==2 || type==4) // If not an input or bias node
		{
			// Iterate through parents and compute sum-product of weights & outputs
			Iterator<NodeWeightPair> parentItr = parents.iterator();
			NodeWeightPair currPair = null;
			sum = 0.0;
			while(parentItr.hasNext()) {
				currPair = parentItr.next();
